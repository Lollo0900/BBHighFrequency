...
with (st.sidebar):
    ...
    entry_z= st.slider("Select the entry Z-score for the strategy:",min_value=0, max_value=5, value=2)

    exit_z = st.slider("Select the exit Z-score for the strategy:", min_value=0, max_value=5, value=2)
